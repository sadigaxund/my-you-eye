...
- **Earth theme** (`earth.css`) — organic/soft with warm sand bg, terracotta primary, sage green dark mode, fully borderless (0px), deep rounded corners (20px/32px), soft warm shadows.
