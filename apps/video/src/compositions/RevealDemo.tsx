...
import { MotionRoot, Reveal } from "my-you-eye/motion";
...
export const RevealDemo: React.FC = () => (
  <MotionRoot mode="video" driver={RemotionDriver}>
    ...
    >
      ...
      <Reveal from="left" delay={10}>
        <h2 style={{ fontSize: 48, margin: "20px 0 0 0", fontWeight: 400 }}>Staggered Entrance</h2>
      </Reveal>
      <Reveal from="right" delay={20}>
      ...
      <Reveal from="scale" spring="bouncy" delay={30}>
        <div
          style={{
            marginTop: 40,
            padding: "20px 40px",
