...
|---|---|---|
| `Canvas` | state: connected / default / highlighted | Empty grid, Ports on grid, Edge states, Edge clickable hit area |
| `ConnectionLine` | variant: bezier / stepped / straight<br>state: connected / default / highlighted / pending | Path variants, States |
...
| `TreeView` | type: button<br>variant: condensed | Default & Condensed (depth-based expand), Controlled expand state |
...
| `StatCard` | — | Default |
| `Toolbar` | size: sm<br>variant: primary / secondary<br>style: soft | All slots filled |
