    ...
    },
    {
      ...
      render: () => (
        <TableGrid>
          ...
          <div role="row" className="contents"><div role="cell" className="p-3 min-w-0 whitespace-nowrap">Bytes</div><div role="cell" className="p-3 min-w-0 [&>*]:w-full"><CellType type="bytes" value={2048} /></div></div>
          <div role="row" className="contents"><div role="cell" className="p-3 min-w-0 whitespace-nowrap">Bytes (large)</div><div role="cell" className="p-3 min-w-0 [&>*]:w-full"><CellType type="bytes" value={1073741824} /></div></div>
